...
WebUI.setText(findTestObject('SignUp-Page/txt_signup_Username'), GlobalVariable.validUsername2)

WebUI.setText(findTestObject('SignUp-Page/txt_signup_Password'), GlobalVariable.invalidPassword1)
...
WebUI.verifyMatch(alertSignUp1, 'Password must at least 6 characters', false)
