...
WebUI.callTestCase(findTestCase('Login/block-signup-success'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Login-Page/txt_login_Password'), GlobalVariable.invalidPassword1)

WebUI.click(findTestObject('Login-Page/btn_Log in'))

WebUI.waitForAlert(2)

alertLogin = WebUI.getAlertText()

println('alert text is: ' + alertLogin)

WebUI.verifyMatch(alertLogin, 'Wrong password.', false)
